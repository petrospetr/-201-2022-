...
<br />
To listing 6.20 είναι τα coherent states. Ο κώδικας του βιβλίου περιέχει την ευρεσή του μέτρου της κυματοσυνάρτησης<br />
των coherent state |Ψ|=\sqrt(Re(Ψ)^2+Im(Ψ)^2), στο οποίο έβγαλα την ρίζα έτσι ώστε να επιστρέφει πιθανότητα.<br />
Κάνει διάγραμα της πιθανότητας για διαφορετικές χρονικές στιγμές \[0,7\] sec για x \in \[-6,6\].
